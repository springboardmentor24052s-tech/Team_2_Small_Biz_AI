...
// Origin that serves user-uploaded files (/uploads/...).
// Derived from the API base so it stays correct when
...
export const getForecast = (days = 30) =>
  api.get(`/ai/forecast?days=${days}`);

export const getSegmentation = () =>
  api.get("/ai/segmentation");

export const getChurnRisk = () =>
  api.get("/ai/churn-risk");
